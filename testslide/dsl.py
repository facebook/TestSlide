...
from typing import Any, Callable, Optional, Union, NoReturn

from testslide import Context, TestCase

from . import Context as _Context, _ContextData
from . import Skip  # noqa: F401


ExampleFunction = Callable[[_ContextData], None]
...
class _DSLContext:
    ...
    def __call__(self, arg: Union[str, ExampleFunction]) -> Union[partial, NoReturn]:
        if callable(arg):
            context_code = arg
    ...
    def sub_context(self, arg: Union[str, ExampleFunction]) -> Union[partial, NoReturn]:
        self._reset()
        return self(arg)

    def xsub_context(self, arg: ExampleFunction) -> NoReturn:
        self._reset()
        self.skip = True
        return self(arg)

    def fsub_context(self, arg: ExampleFunction) -> NoReturn:
        self._reset()
        self.focus = True
        return self(arg)
    ...
    def _create_example(
        self, name: Optional[str], example_code: ExampleFunction, skip: bool, focus: bool
    ) -> NoReturn:
        if name is None:
    ...
    def xexample(self, arg: Union[str, ExampleFunction]) -> NoReturn:
        return self.example(arg, skip=True)

    def fexample(self, arg: Union[str, ExampleFunction]) -> NoReturn:
    ...
    def shared_context(self, arg: Union[str, ExampleFunction]) -> Union[partial, NoReturn]:
        if callable(arg):
    ...
    def merge_test_case(self, test_case: "TestCase", attr_name: str) -> NoReturn:
    ...
    def function(self, function_code: ExampleFunction) -> NoReturn:
    ...
    def before(self, before_code: ExampleFunction) -> NoReturn:
    ...
    def after(self, after_code: ExampleFunction) -> NoReturn:
    ...
    def around(self, around_code: ExampleFunction) -> NoReturn:
